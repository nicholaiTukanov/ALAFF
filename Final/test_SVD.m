...
addpath('../Assignments/flameatlab/')
...
%%% 
%%% First write it so that you compute the Givens' rotations and you apply
...
if norm( svd( A ) - svd( diag( diag( D ) ) ) ) > 1.0e-14 
